...
class PatientTest {
	...
	@Test
	// Heart rate value should only change when it is set to another value by the user
	...
	@Test
	// Cholesterol value should only change when it is set to another value by the user
	...
	// Hemoglobin value should only change when it is set to another value by the user
	@Test
